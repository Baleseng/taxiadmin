<div class="admin-dashboard-chart tabClass" id="btnParked">
      ...
      <div class="dropdown2">
        ...
        <div id="m5" class="dropdown2-content">
          ...
          <div class="index-btn-row">
            <a href="{{ url($url.'/edit/'.$taxi->id . '-' . str_replace(' ', '-', $taxi->registration)) }}"><i class="fa fa-edit"></i>Edit</a>
          </div>
          <div class="index-btn-row">
