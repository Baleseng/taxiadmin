                ...
                <div class="admin-profile-col-4">
                    ...
                    <div class="admin-profile-info">
                        ...
                        <div class="admin-profile-li">
                            ...
                            <form method="POST" action="{{ url('chairman/'.$taxi->id) }}">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
                                <label>Association: </label>
                                <select name="association">
                                    <option selected='selected' value="KPTA">Kempton Park Taxi Association</option>
                                    <option value="JTTA">Johannesburg Tembisa Taxi Association</option>
                                    <option value="ORTIATA">OR Tambo International Airport Taxi Association</option>
                                </select>
                                <input type="hidden" value="{{ Auth::user()->id }}" name="chair_id"/>
